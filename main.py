...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # Baixa a imagem a partir do link enviado
        ...
        # Processa a remoção de fundo usando IA (rembg) mantendo a qualidade original
        output_image = remove(input_image)

        # Prepara a imagem em formato PNG na memória
        ...
        # Envia a imagem tratada como documento para garantir que o Telegram não comprima o PNG
...
# Configurando os handlers do bot
